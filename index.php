                        ...
                        <div class="card bg-gray-900 border-gray-800 shadow-lg h-100">
                            <div class="card-body p-4">
                                <div class="d-flex align-items-center mb-3 gap-3">
                                    <div class="d-flex align-items-center justify-content-center text-orange-500 rounded-3 me-3" style="width: 3rem; height: 3rem; background-color: rgba(234, 88, 12, 0.15); flex-shrink: 0;">
                                    ...
                                    <h3 class="fs-5 fw-semibold text-white mb-0">AI Plan Generator</h3>
                                </div>
                        ...
                        <div class="card bg-gray-900 border-gray-800 shadow-lg h-100">
                            <div class="card-body p-4">
                                <div class="d-flex align-items-center mb-3 gap-3">
                                    ...
                                    <h3 class="fs-5 fw-semibold text-white mb-0">My Plans</h3>
                                </div>
                                <p class="text-gray-400 mb-0">
                        ...
                        <div class="card bg-gray-900 border-gray-800 shadow-lg h-100">
                            <div class="card-body p-4">
                                <div class="d-flex align-items-center mb-3 gap-3">
                                    ...
                                    <h3 class="fs-5 fw-semibold text-white mb-0">Kalender Interaktif</h3>
                                </div>
                                <p class="text-gray-400 mb-0">
                        ...
                        <div class="card bg-gray-900 border-gray-800 shadow-lg h-100">
                            <div class="card-body p-4">
                                <div class="d-flex align-items-center mb-3 gap-3">
                                    ...
                                    <h3 class="fs-5 fw-semibold text-white mb-0">Statistics</h3>
                                </div>
                                <p class="text-gray-400 mb-0">
                        ...
                        <div class="card bg-gray-900 border-gray-800 shadow-lg h-100">
                            <div class="card-body p-4">
                                <div class="d-flex align-items-center mb-3 gap-3">
                                    ...
                                    <h3 class="fs-5 fw-semibold text-white mb-0">AI Smart Coach</h3>
                                </div>
                                <p class="text-gray-400 mb-0">
