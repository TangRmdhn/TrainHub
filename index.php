...
<head>
    ...
    <style>
        ...
        .header-blur {
            background-color: rgba(0, 0, 0, 0.8); /* bg-black with 80% opacity */
        ...
        <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-4">
                    <a href="login.php" class="text-gray-300 hover:text-white transition-colors duration-200">Masuk</a>
                    <a href="register.php" class="bg-brand-DEFAULT hover:bg-brand-dark text-white font-medium py-2 px-4 rounded-lg transition-colors duration-300">
                        Daftar Gratis
                    </a>
                </div>
                ...
                <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div class="text-center lg:text-left">
                        ...
                        <div class="flex justify-center lg:justify-start items-center gap-x-4">
                            <a href="app.php" class="bg-brand-DEFAULT hover:bg-brand-dark text-white font-semibold py-3 px-8 rounded-full text-lg transition-colors duration-300 shadow-lg shadow-brand-dark/30">
                                Mulai Gratis
                            </a>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div class="bg-gray-900 p-6 rounded-xl border border-gray-800 shadow-lg">
                        <div class="w-12 h-12 bg-brand-dark text-brand-light rounded-lg flex items-center justify-center mb-4">
                            <!-- Heroicon: cpu-chip -->
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 3v1.5M4.5 8.25H3m18 0h-1.5M4.5 12H3m18 0h-1.5m-15 3.75H3m18 0h-1.5M8.25 19.5V21M12 3v1.5M12 19.5V21M12 8.25v7.5M15.75 3v1.5M15.75 19.5V21M19.5 8.25h1.5M19.5 12h1.5M19.5 15.75h1.5M15.75 8.25v7.5M8.25 8.25v7.5" /></svg>
                        </div>
