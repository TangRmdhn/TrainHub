    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex-grow w-full">
        ...
        <div class="bg-gray-900 rounded-xl border border-gray-800 shadow-xl">
            <div class="overflow-x-auto">
                <!-- Days Header -->
                <div class="grid grid-cols-7 bg-gray-800 border-b border-gray-700" style="min-width: 100%;">
                    <div class="py-3 text-center text-xs font-semibold text-gray-400 uppercase">Minggu</div>
                    <div class="py-3 text-center text-xs font-semibold text-gray-400 uppercase">Senin</div>
                    <div class="py-3 text-center text-xs font-semibold text-gray-400 uppercase">Selasa</div>
                    <div class="py-3 text-center text-xs font-semibold text-gray-400 uppercase">Rabu</div>
                    <div class="py-3 text-center text-xs font-semibold text-gray-400 uppercase">Kamis</div>
                    <div class="py-3 text-center text-xs font-semibold text-gray-400 uppercase">Jumat</div>
                    <div class="py-3 text-center text-xs font-semibold text-gray-400 uppercase">Sabtu</div>
                </div>

                <!-- Calendar Grid -->
                <div id="calendarGrid" class="calendar-grid" style="min-width: 100%;">
