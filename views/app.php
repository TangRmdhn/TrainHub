            ...
            <div class="lg:col-span-4 space-y-6">
                ...
                <div class="bg-gray-900 rounded-xl border border-gray-800 p-6 shadow-lg">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between items-center py-2 border-b border-gray-800">
                            <span class="text-gray-300 text-sm">Alat</span>
                        ...
                        <div class="flex justify-between items-center py-2">
                            <span class="text-gray-300 text-sm">Level</span>
                ...
                <div class="relative group">
                    ...
                    <div class="relative bg-gray-900 rounded-xl border border-gray-800 p-6">
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                <label class="block text-xs text-gray-300 mb-1">Durasi Program</label>
                            ...
                            <div>
                                <label class="block text-xs text-gray-300 mb-1">Mulai Tanggal</label>
                        ...
                        <div id="loading-text" class="hidden mt-3 text-center">
                            ...
                            <p class="text-[10px] text-gray-400 mt-1">Bisa memakan waktu 5-10 detik</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-8">
                <div id="result-container" class="bg-gray-900/50 rounded-xl border-2 border-dashed border-gray-800 min-h-[500px] flex flex-col p-6 transition-all relative">
                    ...
                    <div id="empty-state" class="absolute inset-0 flex flex-col items-center justify-center text-center p-6">
                        ...
                        <p class="text-gray-400 max-w-sm mx-auto">Hasil racikan AI akan muncul di sini setelah Kamu menekan tombol generate.</p>
                    </div>
    ...
    <script>
        ...
        function renderPlan(planData, startDateInput, durationWeeks) {
                ...
                <div class="mb-6">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                            ...
                            <p class="text-gray-300 text-sm mt-1">Mulai: ${startDateInput} (${durationWeeks} Minggu)</p>
                        </div>
                    </div>
            ...
            if (planData.weekly_schedule && Array.isArray(planData.weekly_schedule)) {
                planData.weekly_schedule.forEach((day, index) => {
                    ...
                    html += `<div>
                                <span class="text-xs text-gray-400 block">HARI KE-${day.day_number}</span>
                                <span class="font-bold text-lg ${isOff ? 'text-gray-400' : 'text-white'}">${day.day_name}</span>
                             </div>`;
                    html += `<span class="text-xs font-bold px-2 py-1 rounded ${isOff ? 'bg-gray-800 text-gray-400' : 'bg-orange-900/30 text-orange-400'}">${isOff ? 'REST' : 'WORKOUT'}</span>`;
                    html += `</div>`;
                ...
                <form id="savePlanForm" action="<?= url('/controllers/save_plan.php'); ?>" method="POST" class="mt-8 p-6 bg-gray-800 rounded-xl border border-gray-700 shadow-xl">
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
                        <div>
                            ...
                            <p class="text-sm text-gray-300">Program akan disimpan ke kalender mulai tanggal <strong class="text-white">${startDateInput}</strong> selama <strong class="text-white">${durationWeeks} Minggu</strong>.</p>
                        </div>
                    </div>
        ...
        function generateWeekSelector() {
            ...
            for (let w = 0; w < 4; w++) {
                ...
                html += `<div class="week-label"><span>${weekLabel}</span> <span class="text-[10px] font-normal text-gray-400">Mulai ${weekStart.getDate()} ${weekStart.toLocaleString('id-ID', { month: 'short' })}</span></div>`;
        ...
        function renderError(msg) {
            ...
            aiResponseContent.innerHTML = `
                <div class="text-center p-8">
                    ...
                    <div class="text-sm text-gray-400 bg-black/30 p-4 rounded text-left overflow-auto max-h-32 font-mono">
