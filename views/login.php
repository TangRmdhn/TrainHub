...
<body class="bg-black text-gray-100 flex items-center justify-center min-h-screen">
    ...
    <div class="bg-gray-900 p-8 rounded-lg border border-gray-800 shadow-xl w-full max-w-md">
        ...
        <p class="text-center text-gray-400 mb-6">Selamat datang kembali</p>

        <form id="login-form" class="space-y-4" action="../controllers/login_controller.php" method="POST">
            <div>
        ...
        <p class="text-center text-sm text-gray-400 mt-6">
            Belum punya akun?
            <a href="register.php" class="font-medium text-orange-500 hover:text-orange-400 transition">Daftar di sini</a>
        </p>
    </div>
