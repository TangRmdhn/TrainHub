            ...
            <div class="team-card gradient-border">
                <div class="bg-gray-900 rounded-[14px] p-8 h-full">
                    <div class="flex flex-col items-center text-center">
                        <!-- Avatar -->
                        <img src="/images/arsyadi.webp" alt="Arsyadi Indra Hasan Prihambada"
                            class="w-32 h-32 rounded-full mb-6 object-cover border-4 border-orange-500 shadow-lg">
            ...
            <div class="team-card gradient-border">
                <div class="bg-gray-900 rounded-[14px] p-8 h-full">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <div class="avatar-placeholder w-32 h-32 rounded-full mb-6">
                            BR
                        </div>
