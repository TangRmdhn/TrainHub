...
<body class="bg-black text-gray-100 min-h-screen">
    ...
    <main class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="mb-12">
            ...
            <p class="text-gray-300 text-lg">Riwayat perubahan dan update TrainHub</p>
            <div class="mt-4 flex items-center gap-3 text-sm">
                <a href="https://github.com/TangRmdhn/TrainHub" target="_blank"
                    class="flex items-center gap-2 text-gray-300 hover:text-orange-500 transition">
                    ...
                    <span>TangRmdhn/TrainHub</span>
                </a>
                <span class="text-gray-600">•</span>
                <span class="text-gray-400" id="commit-count">Loading...</span>
            </div>
        </div>
        ...
        <div id="loading" class="flex flex-col items-center justify-center py-20">
            ...
            <p class="text-gray-300">Mengambil data dari GitHub...</p>
        </div>
