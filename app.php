...
// Pastikan format field sama persis dengan Pydantic model di Python
$profile_for_api = [
...
<head>
    ...
    <style>
        ...
        .day-plan-list ul { list-style: none; padding: 0; margin: 0; }
        .day-plan-list li { 
            margin-bottom: 10px; 
            padding-bottom: 10px;
            border-bottom: 1px solid #374151;
        }
        .day-plan-list li:last-child { border-bottom: none; }
        ...
        .week-selector-btn:hover:not([disabled]) { background: #374151; border-color: #9ca3af; }
        ...
        .day-name { font-size: 10px; font-weight: 600; text-transform: uppercase; color: #9ca3af; }
        .week-selector-btn.selected .day-name { color: #fed7aa; }
        ...
        .week-label::after { content: ''; height: 1px; background: #374151; flex-grow: 1; }
    </style>
</head>
            ...
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center gap-8">
                    ...
                    <div class="hidden md:flex space-x-6">
                        <a href="app.php" class="text-orange-500 font-medium">Dashboard</a>
                ...
                <div class="relative group">
                    ...
                    <div class="relative bg-gray-900 rounded-xl border border-gray-800 p-6">
                        ...
                        <button id="btn-generate-ai" class="w-full bg-orange-600 hover:bg-orange-500 text-white font-bold py-3 px-4 rounded-lg shadow-lg transition-all flex items-center justify-center gap-2">
                            <svg id="loading-spinner" class="hidden animate-spin h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
            ...
            <div class="lg:col-span-8">
                <div id="result-container" class="bg-gray-900/50 rounded-xl border-2 border-dashed border-gray-800 min-h-[500px] flex flex-col p-6 transition-all relative">
                    ...
                    <div id="empty-state" class="absolute inset-0 flex flex-col items-center justify-center text-center p-6">
                        ...
                        <h3 class="text-xl font-bold text-gray-300 mb-2">Belum Ada Data Generated</h3>
                        <p class="text-gray-500 max-w-sm mx-auto">Hasil racikan AI akan muncul di sini setelah Anda menekan tombol generate.</p>
                    </div>
    ...
    <script>
        ...
        function renderPlan(planData) {
            ...
            if(planData.weekly_schedule && Array.isArray(planData.weekly_schedule)) {
                planData.weekly_schedule.forEach((day, index) => {
                    ...
                    html += `<span class="font-bold text-lg ${isOff ? 'text-gray-500' : 'text-white'}">${day.day_name}</span>`;
            ...
            html += `
                <form id="savePlanForm" action="save_plan.php" method="POST" class="mt-8 p-6 bg-gray-800 rounded-xl border border-gray-700 shadow-xl">
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
                        <div>
                            <h3 class="text-lg font-bold text-white">Simpan ke Kalender?</h3>
                            <p class="text-sm text-gray-400">Pilih tanggal <strong class="text-white">SENIN</strong> pertama untuk memulai program ini.</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-end pt-4 border-t border-gray-700">
                            <button type="submit" id="save-plan-btn" class="w-full md:w-auto bg-green-600 hover:bg-green-500 text-white font-bold py-3 px-8 rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg" disabled>
                                Terapkan Jadwal Ini 📅
                            </button>
                        </div>
            ...
            generateWeekSelector(); // Panggil fungsi UI
        ...
        async function handleSavePlan(e) {
            ...
            try {
                ...
                if (result.success) {
                    window.location.href = `calendar.php?highlight=${formData.get('start_date')}`;
                } else {
